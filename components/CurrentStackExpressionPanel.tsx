...
export function CurrentStackExpressionPanel({ rows }: CurrentStackExpressionPanelProps) {
  ...
  return (
    <section className="h-full border border-neutral-900 bg-neutral-100 p-3">
      ...
      <div className="mt-3 border border-neutral-900 bg-white p-3 text-xs leading-5 text-neutral-700">
      ...
      <p className="mt-3 text-[11px] leading-5 text-neutral-700">
        This is the same signed nominal expression used by the deterministic calculator.
      </p>
    </section>
  );
}
